program ballistic_deposition
	...
	double precision :: r, mean, sqmean, std, s
	real :: start, finish
	...
	read(*,*)dis
	write(*,*)"enter the sticking Probability (Between 0 to 1):"
	read(*,*)s
	...
	do k = 1, n
		...
		do i = 1,nmc
			do j = 1, Length
				...
				50 call random_number(r)		

				if(s > r) then				!!-- Random Sticking Probability Condition
